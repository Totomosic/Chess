...
public:
    void Init() override
    {
        ...
        //m_ChessGame->AddPlayer<Chess::UCIEnginePlayer>(Boxfish::TEAM_WHITE, Chess::UCILimits{ -1, 3000 }, std::vector<std::string>{ "bash", "-c", "./shallowblue" });
        //m_ChessGame->AddPlayer<Chess::UCIEnginePlayer>(Boxfish::TEAM_WHITE, Chess::UCILimits{ -1, 3000 }, std::vector<std::string>{ "Boxfish-Cli-1.0.exe" });
